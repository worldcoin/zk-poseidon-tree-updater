...
describe('Proof test', () => {
    it("Should create proof", async () => {
        ...
        const identity_commitment = identity.genIdentityCommitment();
        ...
        const merkleProof: MerkleProof = generateMerkleProof(10, ZERO_VALUE, 5, commitments, identity_commitment)

        const identity_path_index = merkleProof.indices
        const path_elements = merkleProof.pathElements
        ...
        fullProof.publicSignals = [pre_root, post_root]
